...
class SyncfyProvider:
    ...
    def create_connect_session(self,user_ref): return self._request()
    def list_accounts(self,link_id): return self._request()
    def list_transactions(self,link_id,since): return self._request()
    def list_credit_cards(self,link_id): return self._request()
    def delete_link(self,link_id): return self._request()
