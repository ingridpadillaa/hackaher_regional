...
## Documentación de referencia del diseño inicial

La siguiente documentación conserva la propuesta del equipo para la versión Flask. Para el estado actual de React y Firebase, consulta [summa/README.md](summa/README.md).
