...
with sync_playwright() as p:
    ...
    page.screenshot(path="/tmp/summa-inicio-mobile.png", full_page=True)
    ...
    page.screenshot(path="/tmp/summa-copiloto-mobile.png", full_page=True)
    page.get_by_role("button", name="Cerrar", exact=True).click()
    page.set_viewport_size({"width": 1440, "height": 1000})
    page.goto("http://127.0.0.1:5055/")
    page.screenshot(path="/tmp/summa-inicio-desktop.png", full_page=True)
    page.goto("http://127.0.0.1:5055/perfil")
