# Diseño inicial · referencia histórica


La siguiente documentación conserva la propuesta del equipo para la versión Flask. Para el estado actual de React y Firebase, consulta [DESARROLLO.md](DESARROLLO.md).
